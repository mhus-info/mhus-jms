...
public class JmsServiceTest extends TestCase {
    ...
    public void testCommunication() throws JMSException {
        ...
        ClientObjectProxy<TestJmsService> client =
                new ClientObjectProxy<>(con1.createQueue("test"), desc1);

        TestJmsServiceImp impl = new TestJmsServiceImp();
        WebServiceDescriptor desc2 = new WebServiceDescriptor(impl);
        ServerObjectProxy<TestJmsService> server =
                new ServerObjectProxy<>(con2.createQueue("test"), desc2);
        ...
        while (impl.lastAction == null) MThread.sleep(100);
        ...
        // test exception
        {
            ...
            try {
                ...
                e.printStackTrace();
                assertEquals(
                        "ex [de.mhus.lib.core.jms.test.TestJmsServiceImp.throwexception]",
                        e.getMessage());
            }
    ...
    public void testBroadcast() throws JMSException {
        ...
        WebServiceDescriptor desc1 = new WebServiceDescriptor(TestJmsService.class);
        ClientObjectProxy<TestJmsService> client =
                new ClientObjectProxy<>(con1.createTopic("test"), desc1);

        TestJmsServiceImp impl2 = new TestJmsServiceImp();
        WebServiceDescriptor desc2 = new WebServiceDescriptor(impl2);
        ServerObjectProxy<TestJmsService> server2 =
                new ServerObjectProxy<>(con2.createTopic("test"), desc2);

        TestJmsServiceImp impl3 = new TestJmsServiceImp();
        WebServiceDescriptor desc3 = new WebServiceDescriptor(impl3);
        ServerObjectProxy<TestJmsService> server3 =
                new ServerObjectProxy<>(con3.createTopic("test"), desc3);
