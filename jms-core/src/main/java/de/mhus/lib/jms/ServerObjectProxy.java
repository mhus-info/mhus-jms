...
public class ServerObjectProxy<T> extends ServerJms implements JmsObjectProxy {
    ...
    public void receivedOneWay(Message msg) throws JMSException {
        ...
        Object[] obj = null;
        if (msg.propertyExists(ClientObjectProxy.PROP_DIRECT_MSG)
                && msg.getBooleanProperty(ClientObjectProxy.PROP_DIRECT_MSG)) {
            obj = new Object[] {msg};
    ...
    public Message received(Message msg) throws JMSException {
        ...
        try {
            ...
            } else if (res.getResult() instanceof Message) {
            ...
            if (res != null) MJms.setProperties(res.getProperties(), out);
